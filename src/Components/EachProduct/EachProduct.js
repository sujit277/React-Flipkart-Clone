            ...
            <div className="conatiner-fluid mb-5 box14" >
                <div className="row" >
                    <div className="col-md-5 box17">
                        <img className="img box15" src={productitem?.image}  alt="imgicon"></img>
                    </div>
                    <div className="col-md-7 box16" >
                        ...
                        <br></br>
                        <button type="button" className="btn btn-primary mb-3" onClick={()=>dispatch(AddItem(productitem))} >Add to Cart</button>
                        <h1>Description</h1>
