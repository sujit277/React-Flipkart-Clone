        ...
        <>
            <div className="container-fluid">
                <div className="row justify-content-center" style={{ backgroundColor: "#F8F8F8" }}>
                    ...
                    <hr></hr>
                    <p style={{ paddingLeft: "50px", paddingRight: "50px" }}>By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2008-2022 © Flipkart™ Ltd. All rights reserved.</p>
                </div>
            </div>
        </>
    );
