...
const ProductsList = () => {
  ...
  function oneCategory(arr) {
    if (
      arr.category === "women's clothing" &&
      arr.category === "men's clothing"
    ) {
  ...
  return (
    <>
      ...
      <div className="container-fluid mt-5" style={{ padding: "0px 0px" }}>
        <div className="row box5">{data.map(Products)}</div>
      </div>
    </>
  );
};
