      ...
      <div className="container-fluid" style={{ backgroundColor: "#F1F3F6" }}>
        <div className="row justify-content-around">
          <div className="col-7 mb-5 box25 mt-5" style={{ height: "100%" }}>
            ...
            <button
              className="btn btn-danger btn-lg mt-5 mb-3"
              style={{ float: "right" }}
              onClick={OrderPlaced}
            >
              PLACE ORDER
          ...
          <div className="col-4 box25 mt-5" style={{ height: "400px" }}>
            ...
            <h5 className="mb-3">
              Prices of Products<span style={{ float: "right" }}>${total}</span>
            </h5>
            <h5 className="mb-3">
              Coupon For you{" "}
              <span style={{ color: "green", float: "right" }}>-$10</span>
            </h5>
            <h5 className="mb-3">
              Delivery Charges{" "}
              <span style={{ color: "green", float: "right" }}>FREE</span>
            </h5>
            <h4>
              Total Amount
